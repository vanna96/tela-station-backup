...
class TransportationOrderForm extends CoreFormDocument {
  ...
  componentDidMount(): void {
    ...
    if (this.props.edit) {
      if (this.props.location.state) {
        ...
        new TransportationOrderRepository().find(this.props.match.params.id).then((res: any) => {
  ...
  async handlerSubmit(event: any) {
    ...
    await new TransportationOrderRepository().post(this.state, this.props?.edit, id).then((res: any) => {
      const routeData = new TransportationOrder(res?.data)
...
export default withRouter(TransportationOrderForm)