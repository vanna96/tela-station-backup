...
import TransportationOrderC from "./component/LeftSide";
import AvailableTable from "./component/AvailableTable";
...
class TransportationOrder extends CoreItemDocument {
  ...
  async handlerSubmit(event: any) {
    ...
    await new RouteMasterRepository()
      .post(this.state, this.props?.edit, id)
      .then((res: any) => {
        const routeData = new RouteMaster(res?.data);

        this.props.history.replace(
          this.props.location.pathname?.replace("create", routeData.id),
          routeData
        );
