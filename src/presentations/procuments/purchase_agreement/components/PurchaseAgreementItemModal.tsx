...
interface PurchaseAgreementItemModalProps {
    ref?: React.RefObject<PurchaseAgreementItemModal | undefined>,
    onSave?: (value: any) => void,
    columns: any[],
}

export class PurchaseAgreementItemModal extends React.Component<PurchaseAgreementItemModalProps, any>  {
                ...
                <>
                    <div className="flex flex-col gap-3 px-4 py-6 text-xs" key={this.state.key}>
                        ...
                        <div className="grid grid-cols-4 lg:grid-cols-2 sm:grid-cols-1 gap-3">
                            ...
                            <VatGroupTextField label="Tax Code" value={this.state?.VatGroup} onChange={(event) => this.handChange(event, 'VatGroup')} type={"InputTax"} />
