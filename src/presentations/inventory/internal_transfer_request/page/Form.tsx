...
class InternalTransferForm extends CoreFormDocument {
  ...
  componentDidMount(): void {
    ...
    DocumentSerieRepository.getDocumentSeries(
      InternalTransferRepository.documentSerie
    ).then((res: any) => {
  ...
  async handlerSubmit(event: any) {
    ...
    await new InternalTransferRepository()
      .post(this.state, this.props?.edit, id)
      .then((res: any) => {
        const stockTransfer = new InternalTransfer(res?.data);
...
export default withRouter(InternalTransferForm);
