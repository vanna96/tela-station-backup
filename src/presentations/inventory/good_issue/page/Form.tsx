...
class GoodIssueForm extends CoreFormDocument {
  ...
  componentDidMount(): void {
    ...
    DocumentSerieRepository.getDocumentSeries(
      GoodIssueRepository.documentSerie
    ).then((res: any) => {
  ...
  async handlerSubmit(event: any) {
    ...
    await new GoodIssueRepository()
      .post(this.state, this.props?.edit, id)
      .then((res: any) => {
        const stockTransfer = new GoodIssue(res?.data);
...
export default withRouter(GoodIssueForm);
