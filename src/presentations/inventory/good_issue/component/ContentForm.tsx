  ...
  const itemColumns = React.useMemo(
    () => [
      ...
      },
      {
        ...
        header: "Account Code",
        Cell: ({ cell }: any) => {
          return <AccountTextField name='accountCode' value={cell.getValue()} onChange={(accountCode) => handlerChangeInput(accountCode, cell?.row?.original, 'accountCode')} />;
        }
...

      {
        ...
        Cell: ({ cell }: any) => (
          <UOMSelect
            ...
            name="uomEntry"
            onChange={(event) =>
              handlerChangeInput(event, cell?.row?.original, "uomEntry")
            }
          />
        ),
      },
