...
class GoodReceiptPODetails extends Component<any, any> {
  ...
  initData() {
    ...
    const data = this.props.location.state as GoodReceiptPO;
    console.log(data);

    if (data) {
      setTimeout(() => {
        let stockTransfer = data;
        stockTransfer as GoodReceiptPO;
...
export default withRouter(GoodReceiptPODetails);
