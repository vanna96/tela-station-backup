...
import { ModalItemTable } from "./ModalItemTable";

type ItemTableProps = {
  Edit?: any;
};

export const ItemTable = ({ Edit }: ItemTableProps) => {
  const { form, setForm, TaxCode }: any = useContext(FormOrderContext);
