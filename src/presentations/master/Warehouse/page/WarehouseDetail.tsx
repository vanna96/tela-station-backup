...
function General(props: any) {
  ...
  return <div className='grow w-full grid grid-cols-2 sm:grid-cols-1 gap-2 text-[12px] py-2'>
    ...
    <div className='flex flex-col gap-2'>
      ...
      <div className='grid grid-cols-3 gap-2'><span className='text-gray-500'>State</span> <span className='col-span-2 font-medium'>: {new CityRepository().find(data.state)?.Name || "N/A"} ({new CityRepository().find(data.state)?.Code ?? "N/A"})</span></div>
