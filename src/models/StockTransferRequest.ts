...
export interface StockTransferRequestDocumentLineProps {
...
export default class StockTransferRequest extends Model implements MasterDocument {
  id: any;
  docNum: any;
  cardCode?: string;
  cardName?: string;
  ...
  public static toCreate(json: any) {
    ...
    return {
      ...
      StockTransferLines: json["items"]?.map((e: any) =>
        StockTransferRequestDocumentLine.toCreate(e, json["docType"])
      ),
...
export class StockTransferRequestDocumentLine extends Model implements DocumentLine {
